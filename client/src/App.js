...
class App extends Component {
  ...
  setCreditScore = async () => {
    ...
    this.setState({ creditScore: response });
    console.log(this);
  ...
  createLoan = async () => {
    ...
    alert("Credit Score for this id: " + this.state.creditScore)
  ...
  payBackLoan = async () => {
    ...
    console.log(this.state.status[this.state.currentLoan.status]);
    ...
    return (
      <div className="App">
        <div className="Loan-app-header">
          <h1>Peer to Peer Lending system</h1>

          <img
            className="header-img"
            src="https://cdn.iconscout.com/icon/free/png-256/ethereum-3-569581.png"
          />
        ...
        <h4 id="credscore">Credit score is:{this.state.creditScore}</h4>
        <button onClick={this.setCreditScore}>Get Credit Score</button>
        <div className="owner-special-buttons">
          {this.state.shouldShowButton ?   <h6>Owner Panel</h6>
            : <h4>Lender Panel</h4>  }
